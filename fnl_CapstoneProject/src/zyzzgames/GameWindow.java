	...
	implements ActionListener
{
    ...
    // ---------- New: fixed internal canvas at 1920x1080 ----------
    ...
    private final JPanel gameView = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Render the current frame into the 1920x1080 canvas
            renderFrame();
    ...
    // Optional: a simple Swing timer to drive repaints at ~60 FPS
    private final Timer repaintTimer = new Timer(1, e -> gameView.repaint());
    ...
    public GameWindow(int x, int y, int width, int height) {
        ...
        System.out.println(this.getComboBox().getSelectedItem());
    ...
    // ---------- Rendering pipeline ----------
    /** Draws the current frame into the 1920x1080 canvas. */
